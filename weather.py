...
def getWeather():
    # try:
    city=textfield.get()
    geolocator=OpenCage(api_key='aba07668a512482ab904278d39578add')
    location=geolocator.geocode(city)
    obj=TimezoneFinder()ms
...
#weather
    api="https://api.openweathermap.org/data/2.5/weather?q="+city+"&appid=c97e77d8c5e86b9e8046efbc9253dae7"
